...
public class SwitchButton extends CompoundButton {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,// 传入属性集合 及style
                R.styleable.Switch, defStyle, 0); // XXXXXX
        // 获取switch属性集合中定义的每个属性的值
    ...
    // public void onPopulateAccessibilityEvent(View host, AccessibilityEvent
    // event) {
