...
package com.utils.bluetooth.demo.utils;
...
import com.utils.bluetooth.demo.R;
import com.utils.bluetooth.demo.bluetoothUtils.BluetoothClientService;
import com.utils.bluetooth.demo.bluetoothUtils.BluetoothTools;
import com.utils.bluetooth.demo.bluetoothUtils.TransmitBean;
...
//                serversText.append(device.getName() + "\r\n");
                ...
                // 接收数据
                TransmitBean data = (TransmitBean) intent.getExtras().getSerializable(
                        BluetoothTools.DATA);
                String msg = "from remote " + new Date().toLocaleString() + " :\r\n"
                        + data.getMsg() + "\r\n";
                Log.w("ClientActivity", "meg ---------------- " + msg);
